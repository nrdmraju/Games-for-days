...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            ...
            print("Exception: ", e)
            df.to_csv(crashed_tag + 'vgsalesNov_2020.csv', sep=",",
    ...
    df.to_csv('complete-vgsalesNov_2020.csv', sep=",", encoding='utf-8', index=False)
    df_final = df[[
        'Rank', 'Name', 'Platform', 'Year', 'Genre', 'ESRB_Rating',
        'Publisher', 'Developer', 'Critic_Score', 'User_Score',
        'Global_Sales', 'NA_Sales', 'PAL_Sales', 'JP_Sales', 'Other_Sales']]

    df_final.to_csv('vgsalesNov_2020.csv', sep=",", encoding='utf-8', index=False)
    print("Wrote scraper data to", 'vgsalesNov_2020.csv')
